...
public class Fish {
	...
	public Fish(){
		...
		updateFitness(fitness+feasibility[1]);
	}
	...
	public void updateFitness() {
		lastFitness = fitness;
		fitness=FitnessFunction.calculateFitness(position)+this.feasibility[1];
	}
	...
	public void calculateIFeasibility(int iteration){
		...
		if(Double.compare(sumFiDifference,0.0) == 0){
			sumFiDifference = 1;
		}
	...
	public void moveFishIndividualFitness(double step, int iteration) {
		...
		newFitness=FitnessFunction.calculateFitness(candidatePosition)+newFeasibility[1];
