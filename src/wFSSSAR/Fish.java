...
public class Fish {
	...
	public void calculateI(int iteration){
		...
		if(leader!=null){
			...
			if(Double.compare(fishFitness,fishLastFitness)>0 && Double.compare(leaderFitness,leaderLastFitness)>0){
				for(int i=0;i<IToUpdate.length;i++){
	...
	public void moveFishIndividual(double step, double iteration) {
